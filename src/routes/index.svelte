...
import { EchatMessageType } from '../Model/chat';
    //global actions
    const  scrollToBottom = (el)=> { el.scrollTop = el.scrollHeight; };
    let screen = 'chat';
    let navigation = 'discussions';
    const openCall =()=>{
        screen = 'voice';
    }
    const toChat =() =>{
    ...
    const mainContact = [
        {
        image: 'dist/img/avatars/avatar-female-1.jpg',
        first_name: 'Janette',
        last_name: 'Dalton',
        state: 'Sofia',
        country: 'Bulgaria',
    ...
    {
        image: 'dist/img/avatars/avatar-male-1.jpg',
        first_name: 'Michael ',
        last_name: 'Knudsen',
        state: 'Washington',
        country: 'USA',
    ...
    {
        image: 'dist/img/avatars/avatar-female-2.jpg',
        first_name: 'Lean',
        last_name: 'Avent',
        state: 'Shanghai',
        country: 'China',
    ...
    {
        image: 'dist/img/avatars/avatar-male-2.jpg',
        first_name: 'Mariette',
        last_name: 'Toles',
        state: 'Helena',
        country: 'Montana',
    ...
    {
        image: 'dist/img/avatars/avatar-female-3.jpg',
        first_name: 'Harmony',
        last_name: 'Otero',
        state: 'Indore',
        country: 'India',
    ...
    {
        image: 'dist/img/avatars/avatar-female-5.jpg',
        first_name: 'Keith',
        last_name: 'Morris',
        state: 'Chisinau',
        country: 'Moldova',
    ...
    {
        image: 'dist/img/avatars/avatar-female-6.jpg',
        first_name: 'Louis',
        last_name: 'Martinez',
        state: 'Vienna',
        country: 'Austria',
    ...
    {
        image: 'dist/img/avatars/avatar-male-3.jpg',
        first_name: 'Ryan',
        last_name: 'Foster',
        state: 'Oslo',
        country: 'Norway',
    ...
    {
        image: 'dist/img/avatars/avatar-male-4.jpg',
        first_name: 'Mildred',
        last_name: 'Bennett',
        state: 'London',
    ...
    let contacts = mainContact;
    const filterContact =(type = 'all') =>{
        if(type == 'all'){
            contacts = mainContact;
            contacts = contacts;
        }
        if(type == 'online'){
            contacts = mainContact.filter((e)=>{
    ...
    const searchContact = ()=>{
        if(scontact == ''){contacts = mainContact; return};
        contacts = mainContact.filter((e)=>{
            console.log(scontact);
            let result = e.first_name.toLocaleLowerCase().includes(scontact.toLocaleLowerCase()) 
            || e.last_name.toLocaleLowerCase().includes(scontact.toLocaleLowerCase());
            console.log(result);
            return result
        });
        contacts = contacts;
    ...
    //discussion function and properties
    const mainDiscuss =[{
        image: 'dist/img/avatars/avatar-female-1.jpg',
        first_name: 'Jannet',
        last_name: 'Mars',
        ...
        chats: [{
            id: 'ucbdcbcbx',
            status: 'unread',
            text: 'A new feature has been updated to your account. Check it out on saturday I will be there',
            refer: '',
    ...
    let discussions = mainDiscuss;
    let activeDiscussion = discussions[0];
</script>
<svelte:head>
    <title>MEEZI :: chat page </title>
</svelte:head>
	<main>
        <div class="layout">
            <!-- Start of Navigation -->
                ...
                <div class="container">
                    <div class="inside">
                        <div class="nav nav-tab menu">
                            ...
                            <a on:click="{()=>{toggleNav('members')}}" class:active={navigation == 'members'} href="#members" data-toggle="tab">
                                <i class:active={navigation == 'members'} class="material-icons">account_circle</i></a>
                            <a on:click="{()=>{toggleNav('discussions')}}" class:active={navigation == 'discussions'} href="#discussions" data-toggle="tab">
                                <i class:active={navigation == 'discussions'} class="material-icons">chat_bubble_outline</i></a>
                            <a on:click="{()=>{toggleNav('notifications')}}" class:active={navigation == 'notifications'} href="#notifications" data-toggle="tab" class="f-grow1">
                                <i class:active={navigation == 'notifications'} class="material-icons">notifications_none</i></a>
                            <button class="btn mode"><i class="material-icons">brightness_2</i></button>
                            <a on:click="{()=>{toggleNav('settings')}}" class:active={navigation == 'settings'} href="#settings" data-toggle="tab">
                                <i class:active={navigation == 'settings'} class="material-icons">settings</i></a>
                            <button class="btn power" on:click="{logout}"><i class="material-icons">power_settings_new</i></button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="col-md-12">
                        <div class="tab-content">
                            <!-- Start of Contacts -->
                            <div class="tab-pane fade" class:active={navigation == 'members'} class:show={navigation == 'members'} id="members">
                                <div class="search">
                                     <form on:submit|preventDefault="{searchContact}" class="form-inline position-relative">
                                        <input type="search" bind:value="{scontact}" class="form-control" id="people" placeholder="Search for people...">
                                ...
                                <div class="list-group sort">
                                    <button class="btn filterMembersBtn active show" on:click="{()=>{filterContact('all')}}" data-toggle="list" data-filter="all">All</button>
                                    <button class="btn filterMembersBtn" data-toggle="list" on:click="{()=>{filterContact('online')}}" data-filter="online">Online</button>
                                    <button class="btn filterMembersBtn" data-toggle="list" data-filter="offline" on:click="{()=>{filterContact('offline')}}">Offline</button>
                                </div>						
                                <div class="contacts">
                                    <h1>Contacts</h1>
                                    <div class="list-group" id="contacts" role="tablist">
                                       ...
                                       <a href="#" class="filterMembers all contact" data-toggle="list">
                                        <img class="avatar-md" src="{contact.image}" data-toggle="tooltip" data-placement="top" title="{contact.first_name}" alt="avatar">
                                        <div class="status">
                                            <i class="material-icons {contact.status}">fiber_manual_record</i>
                                        </div>
                                        <div class="data">
                            ...
                            <div class:active={navigation == 'discussions'} class:show={navigation == 'discussions'} id="discussions" class="tab-pane fade active show">
                                <div class="search">
                                ...
                                <div class="discussions">
                                    ...
                                    <div class="list-group" id="chats" role="tablist">
                                        {#each discussions as discuss}
                                        <a href="#list-chat" class:active={discuss.image == activeDiscussion.image}  class="filterDiscussions all unread single " id="list-chat-list" data-toggle="list" role="tab">
                                            <img class="avatar-md" src="{discuss.image}" data-toggle="tooltip" data-placement="top" title="{discuss.first_name}" alt="avatar">
                                            <div class="status">
                                                <i class="material-icons online">fiber_manual_record</i>
                                            </div>
                                            <div class="new bg-yellow">
                                                <span>{discuss.chats.filter(()=>{
                                                    
                                                })}</span>
                                            </div>
                                            <div class="data">
                                                <h5>{discuss.first_name + ' ' + discuss.last_name}</h5>
                                                <span>Mon</span>
                                                <p>{discuss.chats[0].text}</p>
                                            </div>
                                        </a>
                                        {/each}
                            ...
                            <div id="notifications" class="tab-pane fade" class:active={navigation == 'notifications'} class:show={navigation == 'notifications'}>
                                <div class="search">
                                    <form class="form-inline position-relative">
                            ...
                            <!-- Start of Settings -->
                            <div class="tab-pane fade" class:active={navigation == 'settings'} class:show={navigation == 'settings'} id="settings">			
                                <div class="settings">
                                    <div class="profile">
            ...
            <div class="main">
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="babble tab-pane fade active show" id="list-chat" role="tabpanel" aria-labelledby="list-chat-list">
                                ...
                                <div class="container">
                                    <div class="col-md-12">
                                        <div class="inside">
                                            ...
                                            <button class="btn connect d-md-block d-none" name="1"><i on:click="{openCall}" class="material-icons md-30">phone_in_talk</i></button>
                        ...
                        <div style="display:block" class="call" id="call1">
                            <div class="content">
                                <div class="container">
                                    <div class="col-md-12">
                                        <div class="inside">
                                            <div class="panel">
                                                ...
                                                <button on:click="{toChat}" class="btn back" name="1"><i class="material-icons md-24">chat</i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
